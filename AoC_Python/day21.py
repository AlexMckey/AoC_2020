#f=open('d:\\YandexDisk\\DevsExercises\\AdventOfCode\\2020\\PuzzleInput\\input21Sample.txt')
f=open('d:\\YandexDisk\\DevsExercises\\AdventOfCode\\2020\\PuzzleInput\\input21.txt')
lines = [line.rstrip('\n') for line in f]
